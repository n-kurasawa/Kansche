...
/**
 * T06WeeklyWorkエンティティクラス
 * 
 */
@Entity
@Table(name = "t06_weekly_work")
...
public class T06WeeklyWork implements Serializable {
    ...
    /** mondayDateプロパティ */
    @Id
    @Column(name = "monday_date", length = 8, nullable = false, unique = false)
