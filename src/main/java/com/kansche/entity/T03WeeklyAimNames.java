...
/**
 * {@link T03WeeklyAim}のプロパティ名の集合です。
 * 
 */
...
public class T03WeeklyAimNames {
     ...
     * @return weekのプロパティ名
     */
    public static PropertyName<String> week() {
        return new PropertyName<String>("week");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _T03WeeklyAimNames extends PropertyName<T03WeeklyAim> {

        /**
         * インスタンスを構築します。
         */
        public _T03WeeklyAimNames() {
        }
         ...
         *            名前
         */
        public _T03WeeklyAimNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _T03WeeklyAimNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return weekのプロパティ名
         */
        public PropertyName<String> week() {
            return new PropertyName<String>(this, "week");
        }
